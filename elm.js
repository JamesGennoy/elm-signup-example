   ...
   var view = function (model) {
      ...
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Sensational Signup Form")]))
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("username-field")]),_U.list([$Html.text("username: ")]))
                              ,A2($Html.input,
                      ...
                      _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("password-field")]),_U.list([$Html.text("password: ")]))
                              ...
                              _U.list([]))]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-default"),$Html$Attributes.type$("submit")]),
                      _U.list([$Html.text("Sign Up!")]))]))]))]))]));
   };
   var main = view({username: "hey now",password: ""});
   return _elm.SignupForm.values = {_op: _op,view: view,main: main};
};
