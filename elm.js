...
Elm.SignupForm.make = function (_elm) {
   ...
   var view = F2(function (actionDispatcher,model) {
      ...
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Sensational Signup Form")]))
              ...
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "form-group",_1: true}
                                                                  ,{ctor: "_Tuple2"
                                                                   ,_0: "has-error"
                                                                   ,_1: !_U.eq(model.errors.username,"") || _U.eq(model.errors.usernameTaken,true)}]))]),
                      _U.list([A2($Html.label,
                              _U.list([$Html$Attributes.$for("username-field"),$Html$Attributes.$class("control-label")]),
                              ...
                              _U.list([]))
                              ,A2($Html.span,_U.list([$Html$Attributes.$class("help-block")]),_U.list([$Html.text(viewUsernameErrors(model))]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "form-group",_1: true}
                                                                  ,{ctor: "_Tuple2",_0: "has-error",_1: !_U.eq(model.errors.password,"")}]))]),
                      _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("password-field")]),_U.list([$Html.text("Password: ")]))
                              ,A2($Html.input,
                              ...
                              _U.list([]))
                              ,A2($Html.span,_U.list([$Html$Attributes.$class("help-block")]),_U.list([$Html.text(model.errors.password)]))]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-default")
                              ,$Html$Attributes.type$("button")
                              ,A2($Html$Events.onClick,actionDispatcher,{actionType: "VALIDATE",payload: ""})]),
